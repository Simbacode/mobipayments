...
public class PesapalCMD {
	...
	public static void main(String[] argv) throws Exception {
		...
		// test
		System.out.println(new Pesapal(new File("").getAbsolutePath()
				+ "\\pesapal.properties").PostPesapalDirectOrderV4(amount,
				desc, type, reference, email, phonenumber, first_name,
				last_name).readBodyAsString());
	}
}
