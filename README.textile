...
!https://secure.travis-ci.org/Simbacode/mobipayments.png?branch=master(travis-ci-status)!!https://coveralls.io/repos/mistaguy/mobipayments/badge.png?branch=master(Coverage Status)!:https://coveralls.io/r/mistaguy/mobipayments?branch=master
